...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.9kpqq.mongodb.net/?retryWrites=true&w=majority`;
...
const run = async () => {
  try {
    ...
    const db = client.db("computerParts");
    ...
    app.get("/", async (req, res) => {
      res.send("Computer Parts Manufacturer Server Running");
    });
